...
public class PostFXSettings : ScriptableObject
{
    ...
    public ToneMappingSettings toneMappingSettings = new ToneMappingSettings
    {
    ...
    {
        /// <summary>
        /// 当不需要校色时，就不进行一系列复杂的校色计算以及LUT的使用
        /// </summary>
        public bool eanbleColorAdjust;
